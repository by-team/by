defmodule BY.Todos.Todo do
  ...
  def changeset(todo, attrs) do
    todo
    |> cast(attrs, [:title, :invoice_link, :invoice_paid_at, :done_at, :not_done_at, :withdraw_link, :withdrawn_at])
    |> validate_required([:title, :invoice_link, :invoice_paid_at, :done_at, :not_done_at, :withdraw_link, :withdrawn_at])
  end
end
